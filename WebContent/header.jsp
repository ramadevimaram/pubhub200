                ...
                <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="admin/BookPublishing">Home (Level 100)</a></li>
                          <li class="divider"></li>
                          <li><a href="admin/publishBook.jsp">Publish Book</a></li>
                          <li class="divider"></li>
                          <li><a href="admin/SearchByTag.jsp">Search Books by Tag</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Marketplace<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="admin/adminConsole.jsp">Home (Level 200)</a></li>
                          <li class="divider"></li>
					      <li><a href="#">Cart</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="admin/FanOutreach.jsp">Home (Level 300)</a></li>
                          <li class="divider"></li>
